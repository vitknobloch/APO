...
(*.[0-9]*)
	...
	if test ! -f /mnt/c/Users/vitak/ownCloud/APO/ncurses-6.2/man_alias.sed ; then
cat >>/mnt/c/Users/vitak/ownCloud/APO/ncurses-6.2/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /mnt/c/Users/vitak/ownCloud/APO/ncurses-6.2/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /mnt/c/Users/vitak/ownCloud/APO/ncurses-6.2/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /mnt/c/Users/vitak/ownCloud/APO/ncurses-6.2/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /mnt/c/Users/vitak/ownCloud/APO/ncurses-6.2/man_alias.sed \
		< $i | sed -f /mnt/c/Users/vitak/ownCloud/APO/ncurses-6.2/edit_man.sed >$TMP
